  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Achaarya: Your Personalized Learning Companion! Leveraging AI to transform school textbooks into interactive chatbots, enhancing learning and invoking APIs like WolframAlpha for maths, Mermaid for mindmaps, and more."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Achaarya: Your Personalized Learning Companion! Leveraging AI to transform school textbooks into interactive chatbots, enhancing learning and invoking APIs like WolframAlpha for maths, Mermaid for mindmaps, and more.`}
            </Text>
            <Box
