...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Chapters', path: '/chapters', entity: 'chapter', service: AccessServiceEnum.PROJECT, icon: FiBookmark },
    {
      name: 'Questions',
      path: '/questions',
      entity: 'question',
    ...
    { name: 'Textbooks', path: '/textbooks', entity: 'textbook', service: AccessServiceEnum.PROJECT, icon: FiBook },
